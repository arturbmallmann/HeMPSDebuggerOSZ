...
import br.pucrs.mpsocdebugger.componentes.UJPanelImagem;
...
public class Roteador extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        router = new br.pucrs.mpsocdebugger.componentes.UJPanelImagem();
        ...
        out_north_HIGH = new br.pucrs.mpsocdebugger.componentes.UJPanelImagem();
        in_north_HIGH = new br.pucrs.mpsocdebugger.componentes.UJPanelImagem();
        out_weast_HIGH = new br.pucrs.mpsocdebugger.componentes.UJPanelImagem();
        in_weast_HIGH = new br.pucrs.mpsocdebugger.componentes.UJPanelImagem();
        in_east_LOW = new br.pucrs.mpsocdebugger.componentes.UJPanelImagem();
        out_east_LOW = new br.pucrs.mpsocdebugger.componentes.UJPanelImagem();
        in_south_LOW = new br.pucrs.mpsocdebugger.componentes.UJPanelImagem();
        out_south_LOW = new br.pucrs.mpsocdebugger.componentes.UJPanelImagem();
        in_south_HIGH = new br.pucrs.mpsocdebugger.componentes.UJPanelImagem();
        out_south_HIGH = new br.pucrs.mpsocdebugger.componentes.UJPanelImagem();
        out_weast_LOW = new br.pucrs.mpsocdebugger.componentes.UJPanelImagem();
        in_weast_LOW = new br.pucrs.mpsocdebugger.componentes.UJPanelImagem();
        in_east_HIGH = new br.pucrs.mpsocdebugger.componentes.UJPanelImagem();
        out_east_HIGH = new br.pucrs.mpsocdebugger.componentes.UJPanelImagem();
        out_north_LOW = new br.pucrs.mpsocdebugger.componentes.UJPanelImagem();
        in_north_LOW = new br.pucrs.mpsocdebugger.componentes.UJPanelImagem();
        local_out = new br.pucrs.mpsocdebugger.componentes.UJPanelImagem();
        local_Label = new javax.swing.JLabel();
        local_in = new br.pucrs.mpsocdebugger.componentes.UJPanelImagem();
        ...
        south_LOW_Label.setBounds(20, 110, 37, 20);
    ...
    private br.pucrs.mpsocdebugger.componentes.UJPanelImagem in_east_HIGH;
    private br.pucrs.mpsocdebugger.componentes.UJPanelImagem in_east_LOW;
    private br.pucrs.mpsocdebugger.componentes.UJPanelImagem in_north_HIGH;
    private br.pucrs.mpsocdebugger.componentes.UJPanelImagem in_north_LOW;
    private br.pucrs.mpsocdebugger.componentes.UJPanelImagem in_south_HIGH;
    private br.pucrs.mpsocdebugger.componentes.UJPanelImagem in_south_LOW;
    private br.pucrs.mpsocdebugger.componentes.UJPanelImagem in_weast_HIGH;
    private br.pucrs.mpsocdebugger.componentes.UJPanelImagem in_weast_LOW;
    private javax.swing.JLabel local_Label;
    private br.pucrs.mpsocdebugger.componentes.UJPanelImagem local_in;
    private br.pucrs.mpsocdebugger.componentes.UJPanelImagem local_out;
    private javax.swing.JLabel north_HIGH_Label;
    private javax.swing.JLabel north_LOW_Label;
    private br.pucrs.mpsocdebugger.componentes.UJPanelImagem out_east_HIGH;
    private br.pucrs.mpsocdebugger.componentes.UJPanelImagem out_east_LOW;
    private br.pucrs.mpsocdebugger.componentes.UJPanelImagem out_north_HIGH;
    private br.pucrs.mpsocdebugger.componentes.UJPanelImagem out_north_LOW;
    private br.pucrs.mpsocdebugger.componentes.UJPanelImagem out_south_HIGH;
    private br.pucrs.mpsocdebugger.componentes.UJPanelImagem out_south_LOW;
    private br.pucrs.mpsocdebugger.componentes.UJPanelImagem out_weast_HIGH;
    private br.pucrs.mpsocdebugger.componentes.UJPanelImagem out_weast_LOW;
    private br.pucrs.mpsocdebugger.componentes.UJPanelImagem router;
